...
val configure : ?level:Current.Level.t -> ?schedule:Current_cache.Schedule.t -> ?timeout:Duration.t -> [ `Git of Current_git.Commit.t | `Dir of Fpath.t | `No_context ] Current.t -> Config.t Current.t
